...
describe('/posts', () => {
    ...
    it('should return 404 for not existed post', async () => {

        let result = await request(app).put('/api/posts/63f754c148b2648952effae9')
            .set('Authorization','Basic YWRtaW46cXdlcnR5')
            .send(
                {
                    title: "post title1223",
    ...
    it('should return 404 for noy existed post', async () => {
    ...
    it('404 for not-existed post', async () => {
        ...
        await request(app).delete('/api/posts/63f754c148b2648952effae9')
            .set('Authorization','Basic YWRtaW46cXdlcnR5')
            .expect(404)
